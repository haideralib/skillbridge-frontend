...
export const CandidateProfilePage = () => {
	...
	const saveProfile = (profile: ICandidateProfile) => {
		if (user) {
			setProfile({ name: user.name, email: user.email, role: "candidate", profile });
		}
		setSaved(true);
